...
class CSRTester extends AnyFlatSpec {
  ...
  it should "work correctly" in {
    simulate(new CSR) { dut =>
      ...
      dut.io.csr_r.poke(0xf11.U(12.W))
      dut.io.rdata.expect(0x79737978.U(32.W))
      dut.io.csr_r.poke(0xf12.U(12.W))
      dut.io.rdata.expect(0x17eb198.U(32.W))
      dut.io.csr_w.poke(0x305.U(12.W))
      dut.io.wdata.poke("hdeadbeef".U(32.W))
      dut.io.wen.poke(true.B)
      dut.clock.step()
      dut.io.wen.poke(false.B)
      dut.io.csr_r.poke(0xb00.U(12.W))
      dut.clock.step()
      ...
      dut.io.csr_r.poke(0x305.U(12.W))
      ...
      dut.clock.step()
      dut.io.csr_r.poke(0x342.U(12.W))
      dut.io.rdata.expect(0x12345678.U(32.W))
      dut.io.csr_r.poke(0x341.U(12.W))
