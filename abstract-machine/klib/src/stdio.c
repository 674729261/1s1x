...
//                          bool negative, unsigned long base, unsigned int
//                          width, unsigned int flags, char *const begin, size_t
//                          max_len) {
...
// int __vasprintf(out_ch_func out, char *buffer, const char *format, va_list
// va,
//                 size_t max_len) {
//   int ret_idx = 0;
...
//               out, &buffer, (unsigned long long)(value > 0 ? value : 0 -
//               value), value < 0, base, width, flags, begin, max_len);

//         } else if (flags & FLAGS_LONG) {
//           const long value = va_arg(va, long);
//           ret_idx += _ntoa_long(out, &buffer,
//                                 (unsigned long)(value > 0 ? value : 0 -
//                                 value), value < 0, base, width, flags, begin,
//                                 max_len);
//         } else {
//           const int value = (flags & FLAGS_CHAR)    ? (char)va_arg(va, int)
//                             : (flags & FLAGS_SHORT) ? (short int)va_arg(va,
//                             int)
//                                                     : va_arg(va, int);
//           ret_idx += _ntoa_long(out, &buffer,
//                                 (unsigned int)(value > 0 ? value : 0 -
//                                 value), value < 0, base, width, flags, begin,
//                                 max_len);
//         }
//       } else {
...
//         } else if (flags & FLAGS_LONG) {
//           ret_idx += _ntoa_long(out, &buffer, va_arg(va, unsigned long),
//           false,
...
//           ret_idx += _ntoa_long(out, &buffer, value, false, base, width,
//           flags,
//                                 begin, max_len);
//         }
//       }
...
// static char *update_to_serial(char *addr, char c, char *begin, size_t
// max_len) {
