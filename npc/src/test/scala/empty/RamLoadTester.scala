...
class RamLoaderTester extends AnyFlatSpec with ChiselScalatestTester {
  behavior of "RamLoader"
  it should "work correctly" in {
    test(new __RamLoadTester_test) { dut =>
      ...
      dut.io.lower2bit.poke("b01".U(2.W))
      dut.io.out.expect("h3456".U(32.W))
      dut.io.lower2bit.poke("b10".U(2.W))
      ...
      dut.io.out.expect("h5678".U(32.W))
      dut.io.lower2bit.poke("b01".U(2.W))
      dut.io.out.expect("hffff8456".U(32.W))
      dut.io.lower2bit.poke("b10".U(2.W))
