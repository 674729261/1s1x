...
enum GI { GI_RESETM2 = 1, GI_POWER = 2, GI_CLOSE = 3, GI_RESETSAVE = 4 };
...
bool CheckFileExists(
    const char *filename); // Receives a filename (fullpath) and checks to see
                           // if that file exists
...
// #define FCEUDEF_DEBUGGER //mbg merge 7/17/06 - cleaning out conditional
// compiles
